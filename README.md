...
- **Reaction balancing** is not performed automatically. For a rigorous ΔG<sub>combustion</sub>, the user may need to balance the reaction and apply the thermodynamic relationship manually or via additional scripting.
